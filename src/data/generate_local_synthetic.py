...
# TeacherModel moved to src/data/local_teacher.py (shared with the local
# knowledge-extraction backend); re-exported here so existing imports and
# CLI docs keep working.
from src.data.local_teacher import TeacherModel  # noqa: F401
